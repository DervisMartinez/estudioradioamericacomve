      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-[#131314]/80 backdrop-blur-xl flex justify-between items-center px-4 md:px-8 h-20 shadow-sm dark:shadow-none border-b border-zinc-200 dark:border-transparent">
        <div className="flex items-center gap-4 md:gap-12">
          ...
          <div className="hidden lg:flex gap-8 items-center font-['Montserrat'] tracking-tight font-bold">
            <button onClick={() => router.push('/')} className="text-[#C13535] dark:text-[#DDDADB] hover:text-[#F07D00] transition-colors duration-300">Inicio</button>
            <button onClick={() => router.push('/programas')} className="text-[#C13535] dark:text-[#DDDADB] hover:text-[#F07D00] transition-colors duration-300 border-b-2 border-[#C13535] dark:border-[#DDDADB] pb-1">Programas</button>
            <button onClick={() => router.push('/contacto')} className="text-[#C13535] dark:text-[#DDDADB] hover:text-[#F07D00] transition-colors duration-300">Contacto</button>
          </div>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {programList.map(program => (
              <div key={program.id} onClick={() => router.push(`/program/${program.id}`)} className="group cursor-pointer">
